    ...
    <div>
        ...
        <el-card>
            ...
            >
                ...
                <el-table-column label="标题" prop="lifeTitle">
                </el-table-column>
            ...
            >
                ...
                >
                    <el-form-item label="标题">
                        <el-input
                            v-model="showForm.lifeTitle"
                            disabled
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="内容">
                        <el-input type="textarea" v-model="showForm.lifeContent" disabled></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
