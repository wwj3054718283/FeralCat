    ...
    <div>
        ...
        <el-card>
            ...
            >
                ...
                <el-table-column label="作者" prop="messageAuthor">
                </el-table-column>
            ...
            >
                ...
                >
                    <el-form-item label="内容" prop="nickname">
                        <el-input type="textarea" v-model="addForm.messageContent"></el-input>
                    </el-form-item>
                </el-form>
                <!-- 底部区域 -->
            ...
            >
                ...
                >
                    <el-form-item label="作者">
                        <el-input
                            v-model="showForm.messageAuthor"
                            disabled
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="内容">
                        <el-input type="textarea" v-model="showForm.messageContent" disabled></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
            ...
            >
                ...
                >
                    <el-form-item label="内容">
                        <el-input type="textarea" v-model="editForm.messageContent"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
