    ...
    <div>
        ...
        <el-card>
            ...
            >
                ...
                <el-table-column label="标题" prop="teachTitle">
                </el-table-column>
            ...
            >
                ...
                >
                    <el-form-item label="标题">
                        <el-input
                            v-model="showForm.teachTitle"
                            disabled
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="内容">
                        <el-input type="textarea" v-model="showForm.teachContent" disabled></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
            ...
            >
                ...
                >
                    ...
                    <el-form-item label="内容">
                        <el-input type="textarea" v-model="editForm.teachContent"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
...
export default {
    ...
    methods: {
        async getTeachList() {
            ...
            const { data: data } = await this.$http.get("teach/list", {
                params: {
