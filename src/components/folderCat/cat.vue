<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>流浪猫信息列表</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <el-card>
            ...
            >
                ...
                <el-table-column label="流浪猫名字" prop="catName">
                </el-table-column>
                <el-table-column label="流浪猫性别" prop="catSex"> </el-table-column>
                <el-table-column label="详情描述" prop="catDescription"> </el-table-column>
            ...
            >
                ...
                <el-form
                    ...
                    label-width="70px"
                >
                    <el-form-item label="猫名字" prop="username">
                        <el-input v-model="addForm.catName"></el-input>
                    </el-form-item>
                    <el-form-item label="猫性别" prop="sex">
                        <el-input class="input-role" v-model="addForm.catSex">
                            <el-select
                                v-model="addForm.catSex"
                                slot="prepend"
                                placeholder="请选择"
                            >
                    ...
                    <el-form-item label="内容" prop="nickname">
                        <el-input type="textarea" v-model="addForm.catDescription"></el-input>
                    </el-form-item>
                </el-form>
                <!-- 底部区域 -->
            ...
            >
                ...
                >
                    <el-form-item label="猫名字">
                        <el-input
                            v-model="showForm.catName"
                            disabled
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="猫性别">
                        <el-input v-model="showForm.catSex" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="详情描述">
                        <el-input type="textarea" v-model="showForm.catDescription" disabled></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
            ...
            >
                ...
                >
                    ...
                    <el-form-item label="猫性别" prop="catSex">
                        <el-input class="input-role" v-model="editForm.catSex">
                            <el-select
                                v-model="editForm.catSex"
                                slot="prepend"
                                placeholder="公"
                            >
                                <el-option label="公" value="公"></el-option>
                    ...
                    <el-form-item label="详情描述">
                        <el-input type="textarea" v-model="editForm.catDescription"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
...
export default {
    ...
    methods: {
        async getTeachList() {
            ...
            const { data: data } = await this.$http.get("cat/list", {
                params: {
        ...
        async seekUserList() {
            ...
            const { data: data } = await this.$http.get("cat/listByCatName", {
                params: {
                    catName: this.seekvalue,
                    pageNum: "1",
                    pageRow:"10",
                },
            });
        ...
        addUser() {
            this.$refs.addFormRef.validate(async (valid) => {
                ...
                console.log(data);
                if (data.code == "200") {
                    this.$message.success("添加流浪猫信息成功！");
        ...
        editUserInfo() {
            this.$refs.editFormRef.validate(async (valid) => {
                ...
                let req = {
                    ...
                    catSex: this.editForm.catSex,
                    catDescription: this.editForm.catDescription,
                ...
                this.getTeachList();
                this.$message.success("修改流浪猫信息成功！");
                // console.log(res);
            });
        },
        // 批量删除用户多选框
        ...
        async removeUserById(id) {
            ...
            const { data: res } = await this.$http.delete(`cat/${id}`);
            if (res.meta.status !== 200) {
        ...
        async setRole(item) {
            console.log(item);
            this.$confirm("是否删除该流浪猫信息, 是否继续?", "提示", {
                confirmButtonText: "确定",
                cancelButtonText: "取消",
                type: "warning",
            })
